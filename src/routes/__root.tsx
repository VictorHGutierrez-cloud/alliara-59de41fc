...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "OCTO OS — The Partnership Operating System" },
      { name: "description", content: "Diagnose, learn, and operate a high-performing B2B partner ecosystem with the OCTO methodology — 8 axes, maturity scoring, and gamified execution." },
      { property: "og:title", content: "OCTO OS — The Partnership Operating System" },
      { property: "og:description", content: "Diagnose, learn, and operate a high-performing B2B partner ecosystem with the OCTO methodology — 8 axes, maturity scoring, and gamified execution." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "OCTO OS — The Partnership Operating System" },
      { name: "twitter:description", content: "Diagnose, learn, and operate a high-performing B2B partner ecosystem with the OCTO methodology — 8 axes, maturity scoring, and gamified execution." },
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <header className="sticky top-0 z-40 glass">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 h-14 flex items-center justify-between">
          <Link to="/" className="flex items-center gap-2 font-display font-bold tracking-tight">
            <span className="inline-block h-6 w-6 rounded-md bg-gradient-to-br from-[var(--octo-1)] via-[var(--octo-4)] to-[var(--octo-5)]" />
            <span>OCTO<span className="text-muted-foreground">.os</span></span>
          </Link>
          <nav className="flex items-center gap-2 text-sm">
            {user ? (
              <>
                <Link to="/dashboard" className="px-3 py-1.5 rounded-md hover:bg-surface-2" activeProps={{ className: "px-3 py-1.5 rounded-md bg-surface-2" }}>Dashboard</Link>
                <Link to="/diagnostic" className="px-3 py-1.5 rounded-md hover:bg-surface-2" activeProps={{ className: "px-3 py-1.5 rounded-md bg-surface-2" }}>Diagnostic</Link>
      ...
      <footer className="border-t border-border/50 py-6 text-center text-xs text-muted-foreground">
        OCTO OS · A partnership operating system for B2B teams
      </footer>
    </div>
  );
}
