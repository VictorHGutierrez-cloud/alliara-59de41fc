...
export const AXES: Axis[] = [
  {
    ...
    name: "Strategic Fit",
    tagline: "Are they going after the same buyers and the same future you care about?",
    color: "octa-1",
    icon: "Compass",
    mentalModel:
  ...
  },
  {
    ...
    name: "Sales and Delivery Capacity",
    tagline: "Do they have real sellers and implementers, or mostly good intentions?",
    color: "octa-2",
    icon: "Package",
    mentalModel:
  ...
  },
  {
    ...
    tagline: "Can they run discovery and solid demos without you on every call?",
    color: "octa-3",
    icon: "GraduationCap",
    mentalModel:
  ...
  },
  {
    ...
    name: "Leads and Pipeline",
    tagline: "Do they bring real qualified leads, or mostly follow along on your funnel?",
    color: "octa-4",
    icon: "TrendingUp",
    mentalModel:
  ...
  },
  {
    ...
    tagline: "When this partner delivers, do customers start strong and stay satisfied?",
    color: "octa-5",
    icon: "Handshake",
    mentalModel:
  ...
  },
  {
    ...
    tagline: "Are they using your portal, MDF, and tiers, or signed up and gone quiet?",
    color: "octa-6",
    icon: "Settings2",
    mentalModel:
  ...
  },
  {
    ...
    tagline: "Day to day, are they proactive, clear, and easy to work with?",
    color: "octa-7",
    icon: "Users",
    mentalModel:
  ...
  },
  {
    ...
    tagline: "Do the customers they touch renew, expand, and feel well supported?",
    color: "octa-8",
    icon: "Sparkles",
    mentalModel:
