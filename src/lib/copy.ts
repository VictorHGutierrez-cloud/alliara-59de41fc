...
export const COPY = {
  ...
  jbp: {
    ...
    editMoveTitle: "Edit task",
    editFieldAxis: "Axis",
    editFieldTitle: "Title *",
    editFieldDescription: "Description",
    editFieldPriority: "Priority",
    editFieldTarget: "Target level",
    editFieldDue: "Due date",
    cancelCta: "Cancel",
    saveMoveCta: "Save task",
    priorityLow: "Low",
    priorityMedium: "Medium",
    priorityHigh: "High",
    editTaskAria: "Edit task",
    emailStakeholderAria: "Email stakeholder",
  },
  ...
  emailComposer: {
    ...
    bodyLabel: "Message",
    openMailClientCta: "Open email app",
    subtitleBlurb: "Compose here, then open your email client with fields filled.",
    emptyStakeholdersHint: "Add a stakeholder with an email on the Stakeholders tab.",
    loadErrorHint: "Could not load stakeholders. You can still type an address manually.",
  },
  ...
  portfolio: {
    ...
    tasksNoMatchFilters: "No tasks match your filters. Try a different search or filter.",
    openTasksShowingCap: ({ n }: { n: number }) =>
      `Showing first ${n} tasks. Open a partner for the full list.`,
    taskSearchPlaceholder: "Search tasks…",
    taskFilterPartnerAria: "Filter tasks by partner",
    taskFilterAxisAria: "Filter tasks by dimension",
    taskFilterStatusAria: "Filter tasks by workflow status",
    taskFilterPriorityAria: "Filter tasks by priority",
    taskFilterPartnerAll: "All partners",
    taskFilterAxisAll: "All dimensions",
    taskFilterStatusAll: "All statuses",
    taskFilterPriorityAll: "All priorities",
    taskFilterStatusTodo: "Planned",
    taskFilterStatusDoing: "In motion",
    taskFilterStatusDone: "Delivered",
    maturityDashboardTitle: "Maturity",
    maturityDashboardSubtitle:
      "Scores come from diagnostics (1–5 scale). Higher means stronger channel readiness on average across dimensions.",
    maturityCurrentScore: "Current average score",
    maturityCurrentLevel: "Level",
    maturityRunHistory: "Progress over time",
    maturityRunsCount: ({ n }: { n: number }) => `${n} diagnostic ${n === 1 ? "run" : "runs"}`,
    maturityAxisTrendsEyebrow: "By dimension (latest)",
    maturityEmptyTitle: "No diagnostic yet",
    maturityEmptyBody: "Run a diagnostic once to see maturity level and trends here.",
    maturityRunDiagnosticCta: "Run diagnostic",
    maturityViewOverviewCta: "Open overview",
    maturityChartFootnote: "Average score across dimensions on each diagnostic run.",
  ...
  partnerWorkspace: {
    ...
    maturityPageMetaTitle: "Maturity · Alliara",
    intelPageIntro:
